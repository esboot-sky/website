...
- Optimize Website UI
- Support [Template](/docs/4.0/docs/development/template) variables
...
- Refactor config
- [Restrict key naming in lang json](/docs/4.0/docs/development/i18n#naming-convention)
...
- Support vue projects, see [Plugin-vue](/docs/4.0/docs/plugins/plugin-vue)
