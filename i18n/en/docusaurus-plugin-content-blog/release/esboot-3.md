...
For the migration guide, refer to the existing v3 docs here:

[Migrate to ESBoot 3](/docs/3.0/docs/migration/migration-v3)
...
Refer to the existing v3 migration guide here: [Migrate to ESBoot 3](/docs/3.0/docs/migration/migration-v3)
