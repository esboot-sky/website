...
参考[codesplitting](https://umijs.org./api/config#codesplitting)，配置完全相同，除了`jsStrategyOptions`。
...
开启[svgr](https://react-svgr.com./webpack/)之后可以写成
...
参考[svgrOptions](https://react-svgr.com./options/)
...
- [terser](https://terser.org./api-reference/#minify-options)
- [swc](https://swc.rs./configuration/minification#configuration)
...
- [cssnano](https://cssnano.co./config-file/)
